...
import { LayoutDashboard, FileUp, Bell, LogOut, Loader2, CheckCircle2, Trash2, X, Settings } from "lucide-react";
        ...
        <aside className="w-64 border-r border-gray-200 dark:border-gray-800 flex flex-col">
          <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
            ...
            <button
              ...
              className="p-2 text-gray-600 dark:text-gray-400 hover:text-black dark:hover:text-white rounded-full hover:bg-gray-100 dark:hover:bg-gray-900 transition-colors relative cursor-pointer animate-none"
            ...
            {loading ? (
              ...
              <div className="flex flex-col items-center justify-center py-24 px-4 text-center">
                ...
                <p className="text-xs text-gray-500 dark:text-gray-400 mt-1 max-w-[240px] mx-auto">
                  When you receive campaign updates or system alerts, they will appear here.
                </p>
              </div>
            ) : (
