...
import { Loader2, Key, User, ShieldCheck, AlertCircle, CheckCircle, Sun, Moon, Monitor } from "lucide-react";
  ...
  return (
    <div className="space-y-8 max-w-4xl">
      <header>
        ...
        <p className="text-gray-500 mt-1">Manage your marketer profile details and theme preferences.</p>
      </header>
